  ...
  <div>
    <nav>
      <div class="nav-container">
        ...
        <router-link class="btn btn-info" :to="{name:'nasapage'}">Cree element nasa</router-link>

        <router-link class="btn btn-info" :to="{name:'user-page'}">Cree un user</router-link>
        

        <ul id="icons">
          <li>
            <router-link :to="{name:'likes-setting'}">
